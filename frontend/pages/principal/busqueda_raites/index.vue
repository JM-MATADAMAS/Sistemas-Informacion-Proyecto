  ...
  <div>
    <v-row>
      ...
      <v-col cols="6">
        ...
        <!-- Viajes disponibles -->
        <v-card-title class="title-busqueda fuente" style="color: #717171; font-family: 'Verdana', sans-serif;">
          Viajes disponibles
        </v-card-title>
        <!-- Filtros -->
        <v-container>
              ...
              <v-col>
                <v-container>
                  <v-col style="display: flex;">
                    ...
                    <v-card-subtitle id="num-per-disponibles-raite" style="color: white;">
                      {{ viaje.espacio_disponible }}
                    </v-card-subtitle>
                    <v-icon color="white">
                      mdi-calendar-clock
                    </v-icon>
                    <v-card-subtitle id="hora-fecha-raite" style="color: white">
                ...
                <v-container class="raite-cont-title-price">
                  <v-row>
                    ...
                    <v-col cols="3" class="raite-con-precio">
                      <v-card-subtitle class="raite-precio text-h4">
                        {{ '$' + viaje.costo }}
                      </v-card-subtitle>
                    </v-col>
                  </v-row>
